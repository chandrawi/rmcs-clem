...
do
	...
	then
		...
		/opt/rmcs-gateway/.venv/bin/python /opt/rmcs-gateway/transfer/transfer_local.py &
	...
	then
		...
		/opt/rmcs-gateway/.venv/bin/python /opt/rmcs-gateway/transfer/transfer_server_first.py &
	...
	then
		...
		/opt/rmcs-gateway/.venv/bin/python /opt/rmcs-gateway/transfer/transfer_server_last.py &
